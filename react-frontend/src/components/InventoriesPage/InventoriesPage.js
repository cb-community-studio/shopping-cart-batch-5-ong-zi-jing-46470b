...
import InventoriesFakerDialogComponent from "./InventoriesFakerDialogComponent";
import InventoriesSeederDialogComponent from "./InventoriesSeederDialogComponent";
...
const InventoriesPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service("inventories").remove(data[selectedEntityIndex]?._id);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <div className="col flex justify-content-end">
                    <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="inventories-add-button"/>
            ...
            <div className="grid col-10">
                <div className="col-12" role="inventories-datatable">
            ...
            <InventoriesFakerDialogComponent show={showFakerDialog} onHide={() => setShowFakerDialog(false)} onFakerCreateResults={onFakerCreateResults} />
            <InventoriesSeederDialogComponent show={showSeederDialog} onHide={() => setShowSeederDialog(false)} onSeederResults={onSeederResults} />
        </div>
    );
};
