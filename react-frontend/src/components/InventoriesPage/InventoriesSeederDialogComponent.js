...
import seederData from "./inventories.seeder.json";
...
const InventoriesSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(InventoriesSeederDialogComponent);
